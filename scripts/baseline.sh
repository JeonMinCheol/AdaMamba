...
main_path=/data/a2019102224/archive/AdaMamba/run_longExp.py
...
#     --patch_len 16\
#     --stride 8\
#     --batch_size 128 --learning_rate 0.0001 >logs/LongForecasting/$model_name'_'$model_id_name'_'$seq_len'_'$pred_len.log 
...
#     --e_layers $e_layers \
#     --n_heads $n_heads \
#     --batch_size 128 --learning_rate 0.005 >logs/LongForecasting/$model_name'_'$model_id_name'_'$seq_len'_'$pred_len.log 
...
# model_name=AdaMamba
# for kernels in "3,6,12,24,48,96,192"; do
# data_path_name=ETTh2.csv
# model_id_name=ETTh2
# data_name=ETTh2
# python $main_path \
...
# default setting
# =================================================================================================================================================================
lambda_trend_loss=${LAMBDA_TREND_LOSS:-0.1}
trend_target_mode=${TREND_TARGET_MODE:-extractor}
model_name=AdaMamba
for pred_len in 96 192 336 720; do
# data_path_name=ETTh1.csv
# model_id_name=ETTh1
...
#     --norm_type AdaNorm \
#     --use_trend_forecast True \
#     --lambda_q_loss 0.1 > logs/LongForecasting/$model_name'_'$model_id_name'_'$seq_len'_'$pred_len'_tl'$lambda_trend_loss'_ttm'$trend_target_mode.log 
