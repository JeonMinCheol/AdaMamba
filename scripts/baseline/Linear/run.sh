...
# torchrun --nproc_per_node=4 /data/a2019102224/PatchTST_supervised/run_longExp.py \
      ...
      # --n_heads $n_heads \
      # --des 'Exp' \
      # --itr 1 --batch_size 512 --learning_rate 0.005 >logs/LongForecasting/$model_name'_'$model_id_name'_'$seq_len'_'$pred_len.log 
...
#    --enc_in 321 \
#    --des 'Exp' \
#    --itr 1 --batch_size 16  --learning_rate 0.001  >logs/LongForecasting/$model_name_'$model_id_name'_'electricity_$seq_len'_'336.log  
