...
# torchrun --nproc_per_node=2 /data/a2019102224/PatchTST_supervised/run_longExp.py \
...
# torchrun --nproc_per_node=2 --master-port 12345 /data/a2019102224/PatchTST_supervised/run_longExp.py \
#        --random_seed $random_seed \
#        --is_training 1 \
#        --root_path $root_path_name \
#        --data_path $data_path_name \
